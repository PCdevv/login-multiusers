                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">About Developers</div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Adapun beberapa orang yang berperan dalam membuat website ini, yaitu :
                                    <div class="flex gap-8">
                                        <ul class="list-disc">
                                            <li>Puteri Citra Dewi</li>
                                            <li>Farhan Adamsyahrani L</li>
                                            <li>Joe Davida H</li>
                                        </ul>
                                        <ul class="list-disc">
                                            <li>Muh Sa'da Zidan</li>
                                            <li>Rangketama Abednego P</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>

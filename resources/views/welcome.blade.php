...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Login Multiuser & Role</title>
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex font-black leading-loose text-2xl justify-center sm:justify-start sm:pt-0 items-center">
                    BisaAI - SMK PK
                </div>
                <div class="flex font-semibold leading-normal text-lg justify-center sm:justify-start sm:pt-0 items-center">
                    Project Capstone Cyber Security
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">About Web</div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Website ini dibuat sebagai Tugas Akhir dari program pelatihan SMK-PK BisaAI, yaitu Project Capstone. <br> <br> <br>
                                    <p class="italic">Builded with Laravel Breeze, Laratrust, and some cup of coffee</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">About Developer</div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    <p>Hai, saya <b>Puteri Citra Dewi</b>.</p>
                                    <p><i>Software and Game Developing</i> student</p>
                                    <p>at <b>SMK N 2 MAGELANG</b></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">Roles</div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Try it!</div>
                            </div>
                                    ...
                                    <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                        @auth
                                            <a href="{{ url('/dashboard') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">
                                                <button type="button" class="text-gray-900 hover:text-white border border-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800">Dashboard</button></a>
                                        @else
                                            <a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">
                                                <button type="button" class="text-gray-900 hover:text-white border border-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800">Log in</button></a>
                                        @if (Route::has('register'))
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                        <div class="flex items-center">
                            ...
                            <a href="mailto:putericitradev@gmail.com?subject=Let's%20work%20together!&body=I%20need%20a%20website%2C%20could%20you%20help%20me%3F" class="mx-2 underline">
                                For bussines inquire
                            </a>
                            <a href="https://api.whatsapp.com/send/?phone=62895422529607&text=Hi%2C+Can+you+make+a+wesite+for+me%3F&type=phone_number&app_absent=0" class="ml-2">
